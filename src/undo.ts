...
import {addEvent, gos, OFFSCREEN} from "./init.js";


const lastGameState = new Array<GameObject2>();
...
function deepCopy2(source: GameObject): GameObject {
    const res: GameObject=new GameObject();
    if(source.mouse){
        res.mouse={
...
function deepCopy3(source: GameObject): GameObject {
...
function deepCopyCard(source: CardObject): CardObject {
...
function copy(gos: GameObject2): GameObject2 {
